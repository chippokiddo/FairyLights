...
struct FairyLightsApp: App {
        ...
        MenuBarExtra {
            VStack {
                ...
                Button("About Fairy Lights") {
                    showWindow(id: "about", view: AboutView(), title: "About Fairy Lights")
                }
                ...
                Button("Settings...") {
                    showWindow(
                        id: "settings",
                        view: SettingsView(checkForUpdates: {
                            checkForAppUpdates()
                        })
                        .environmentObject(appState), title: "Fairy Lights Settings")
                }
    ...
    private func showWindow<T: View>(id: String, view: T, title: String) {
        if windows[id] == nil {
